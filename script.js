...
function buildHazardRow(y, laneOffset) {
  ...
  hazard.w = chosenType === 'wall' ? canvas.width * 0.33 : 120;
  hazard.h = chosenType === 'wall' ? 90 : 120;
...
class Entity {
  ...
  draw(dy) {
    ...
    if (this.type === 'gate') {
      ...
      const body = positive ? '#28a85f' : '#cf4949';
      const bodyDark = positive ? '#1b6f3e' : '#8b2424';
